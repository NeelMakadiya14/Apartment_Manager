...
public class expense extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.expense, container, false);

        Button button2 = rootView.findViewById(R.id.menu3_btn);

        final LinearLayout linearLayout = rootView.findViewById(R.id.expensell);
        final Switch Switch = rootView.findViewById(R.id.switch1);

        final EditText date2 = rootView.findViewById(R.id.menu3_date);
        final EditText amount2 = rootView.findViewById(R.id.menu3_amount);
        final EditText description2 = rootView.findViewById(R.id.menu3_Description);
        final EditText wing2 = rootView.findViewById(R.id.menu3_wing);
        final EditText block2 = rootView.findViewById(R.id.menu3_block);
        final EditText name2=rootView.findViewById(R.id.menu3_name);
        final EditText mobile2=rootView.findViewById(R.id.menu3_mobile);
            ...
            public void onClick(View view) {
                if (!(Switch.isChecked())) {
                    ...
                    if (!(amount2.getText().toString().isEmpty() || description2.getText().toString().isEmpty())) {
                        myHelper.insert_into_table(day, month, year, amount2.getText().toString(), description2.getText().toString(), "common", 1);
                    }
                } else {
                    if (amount2.getText().toString().isEmpty()) {
                        amount2.setError("Required");
                    ...
                    if (!(amount2.getText().toString().isEmpty() || description2.getText().toString().isEmpty() || wing2.getText().toString().isEmpty() || block2.getText().toString().isEmpty())) {
                        myHelper.insert_into_table(day, month, year, amount2.getText().toString(), description2.getText().toString(), wing2.getText().toString() + "-" + block2.getText().toString(), 1);
                    }
                }
                upload_expense(context);
    ...
    public void upload_expense(Context context) {
        ...
        myRef.keepSynced(true);
       // myRef.setValue(null);
        myRef.child("Expense").setValue(null);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                myRef.child("Expense").updateChildren(childUpdate);
